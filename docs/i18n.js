...
const ZH = {
  ...
  heroText: 'Quip 会先理解作者到底想表达什么，再抓住具体细节接话。自适应、幽默、真诚或犀利，由你选。',
  download: '下载插件', source: '看源码', generated: 'Quip 生成',
  demoNote: '示例效果，帮你感受风格。实际回复由你选的模型现场生成。',
  whyKicker: '为什么不一样', whyTitle: '先理解意思，再找到值得接的那句话',
  whyLead: 'Quip 会判断作者是在分享、吐槽、自嘲、求助还是抛梗，再用<b>写手 × 编辑双视角自审</b>围绕具体细节接话，淘汰万能附和、误读、复述和尬梗。',
  styleTitle: '四种风格，快捷重写', styleText: '自适应、幽默、真诚、犀利；生成后还能一键改成更短、更自然或更有梗。',
  ...
  modelsTitle: '模型任选', modelsText: 'DeepSeek、OpenAI、Grok、Claude、Gemini、OpenRouter，填自己的 Key。',
  ...
  step2Title: '选模型，填 Key', step2Text: '点 Quip 图标，选择模型并填入对应 API Key，设置会自动保存。',
